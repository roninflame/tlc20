...
namespace TMPro
{
    ...
    [System.Serializable] public class EmotionEvent : UnityEvent<EmotionType> { }
            ...
            IEnumerator Read()
            {
                ...
                WaitForSeconds EvaluateTag(string tag)
                {
                    if (tag.Length > 0)
                    {
                        ...
                        {
                            onEmotionChange.Invoke((EmotionType)System.Enum.Parse(typeof(EmotionType), tag.Split('=')[1]));
                        }
