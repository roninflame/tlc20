...
{
    public class WeaponPowerUpItem : CommonItem
    {
        ...
        {
            ObjectPoolWeaponPowerUpItem.Instance.ReturnToPool(this);
        }
        private void OnTriggerEnter(Collider other)
        {
            ...
            if (player != null && !_canInteract)
            {
                ...
                CanvasManager.Instance.uiWeaponSlots.uiWeaponBasic.AddValue(_itemValue);
