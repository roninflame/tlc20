...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtDebrisSpawner : MonoBehaviour
	{
		...
		public float ShowSpeed { set { showSpeed = value; } get { return showSpeed; } } [FSA("ShowSpeed")] [SerializeField] private float showSpeed = 10.0f;

		/// <summary>The distance from the follower that debris begins spawning.</summary>
		public float ShowDistance { set { showDistance = value; } get { return showDistance; } } [FSA("ShowDistance")] [SerializeField] private float showDistance = 0.9f;

		/// <summary>The distance from the follower that debris gets hidden.</summary>
		public float HideDistance { set { hideDistance = value; } get { return hideDistance; } } [FSA("HideDistance")] [SerializeField] private float hideDistance = 1.0f;

		/// <summary>Should all the debris be automatically spawned at the start?</summary>
		public bool SpawnOnAwake { set { spawnOnAwake = value; } get { return spawnOnAwake; } } [FSA("SpawnOnAwake")] [SerializeField] private bool spawnOnAwake;

		/// <summary>The maximum amount of debris that can be spawned.</summary>
		public int SpawnLimit { set { spawnLimit = value; } get { return spawnLimit; } } [FSA("SpawnLimit")] [SerializeField] private int spawnLimit = 50;

		/// <summary>The minimum amount of seconds between debris spawns.</summary>
		public float SpawnRateMin { set { spawnRateMin = value; } get { return spawnRateMin; } } [FSA("SpawnRateMin")] [SerializeField] private float spawnRateMin = 0.5f;

		/// <summary>The maximum amount of seconds between debris spawns.</summary>
		public float SpawnRateMax { set { spawnRateMax = value; } get { return spawnRateMax; } } [FSA("SpawnRateMax")] [SerializeField] private float spawnRateMax = 1.0f;

		/// <summary>The minimum scale multiplier applied to spawned debris.</summary>
		public float SpawnScaleMin { set { spawnScaleMin = value; } get { return spawnScaleMin; } } [FSA("SpawnScaleMin")] [SerializeField] private float spawnScaleMin = 1.0f;

		/// <summary>The maximum scale multiplier applied to spawned debris.</summary>
		public float SpawnScaleMax { set { spawnScaleMax = value; } get { return spawnScaleMax; } } [FSA("SpawnScaleMax")] [SerializeField] private float spawnScaleMax = 1.0f;
		...
		public List<SgtDebris> Debris { get { if (debris == null) debris = new List<SgtDebris>(); return debris; } } [FSA("Debris")] [SerializeField] private List<SgtDebris> debris;
...
#if UNITY_EDITOR
		[UnityEditor.MenuItem(SgtHelper.GameObjectMenuPrefix + "Debris Spawner", false, 10)]
