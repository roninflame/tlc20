...
namespace SpaceGraphicsToolkit
{
	...
	[HelpURL(SgtHelper.HelpUrlPrefix + "SgtTerrainPrefabSpawner")]
	[AddComponentMenu(SgtHelper.ComponentMenuPrefix + "Terrain Prefab Spawner")]
	public class SgtTerrainPrefabSpawner : MonoBehaviour
	{
		...
		private Transform Spawn(double3 localPoint, double3 localH, double3 localV, double weight)
		{
			...
			if (sharedMaterial != null)
			{
				...
				{
					SgtHelper.AddMaterial(renderer, sharedMaterial.Material);
				}
			}
