...
namespace SpaceGraphicsToolkit
{
	...
	public abstract class SgtTerrain : MonoBehaviour
	{
		...
		public event BuildHeightsDelegate OnScheduleHeights;
		...
		public event BuildHeightsDelegate OnScheduleCombinedHeights;
		...
		{
			if (OnScheduleCombinedHeights != null)
			{
				OnScheduleCombinedHeights.Invoke(points, heights, ref handle);
			}
		}

		public void InvokeScheduleHeights(NativeArray<double3> points, NativeArray<double> heights, ref JobHandle handle)
		{
			if (OnScheduleHeights != null)
			{
				OnScheduleHeights.Invoke(points, heights, ref handle);
			}
		}
