Shader "Hidden/SgtSingularitySRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			CGPROGRAM
				...
				#pragma multi_compile __ SGT_A // Tint
				#pragma multi_compile __ SGT_B SGT_C // Fade Center, Fade Fragment
				...
				void Frag(v2f i, out f2g o)
				{
					...
					o.color.rgb = tex2D(_CameraOpaqueTexture, UnityStereoTransformScreenSpaceTex(coord)).rgb;
