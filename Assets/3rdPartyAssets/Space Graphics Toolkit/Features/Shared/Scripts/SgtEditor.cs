...
namespace SpaceGraphicsToolkit
{
		...
		where T : Object
	{
		...
		protected void Draw(string propertyPath, ref bool modified, string overrideTooltip = null)
		{
		...
		protected void Draw(string propertyPath, ref bool modified1, ref bool modified2, string overrideTooltip = null)
		{
			if (Draw(propertyPath, overrideTooltip) == true)
			{
				modified1 = true;
