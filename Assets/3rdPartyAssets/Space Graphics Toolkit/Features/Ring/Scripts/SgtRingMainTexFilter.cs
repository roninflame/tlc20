...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtRingMainTexFilter : MonoBehaviour
	{
		...
		public float Power { set { if (power != value) { power = value; DirtyTexture(); } } get { return power; } } [FSA("Power")] [SerializeField] private float power = 0.5f;

		/// <summary>This allows you to control the brightness.</summary>
		public float Exposure { set { if (exposure != value) { exposure = value; DirtyTexture(); } } get { return exposure; } } [FSA("Exposure")] [SerializeField] [Range(-1.0f, 1.0f)] private float exposure = 0.0f;
