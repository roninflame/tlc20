...
Shader "Toony Colors Pro 2/User/Toon_base"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		TCP2_TEX2D_WITH_SAMPLER(_MatCapColor1);
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float3 __matcapColor = ( _MatCapColor.rgb * TCP2_TEX2D_SAMPLE(_MatCapColor1, _MatCapColor1, input.pack3.xy).rgb );
				...
				float3 __specularColor = ( _SpecularColor.rgb * TCP2_TEX2D_SAMPLE(_SpecularColor1, _SpecularColor1, input.pack3.xy).rgb );
...
/* TCP_DATA u config(unity:"2020.3.7f1";ver:"2.8.1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","SPECULAR","SPECULAR_SHADER_FEATURE","MATCAP_ADD","MATCAP","MATCAP_SHADER_FEATURE","BUMP","BUMP_SCALE","BUMP_SHADER_FEATURE","RAMP_BANDS","SPEC_LEGACY","SPECULAR_TOON_BAND","EMISSION","OUTLINE","WIND_ANIM_SIN","WIND_ANIM","WIND_SIN_2","WIND_SHADER_FEATURE","MATCAP_PERSPECTIVE_CORRECTION","MATCAP_PIXEL","SKETCH_GRADIENT","SKETCH_SHADER_FEATURE","TEXTURED_THRESHOLD","TT_SHADER_FEATURE","SKETCH_AMBIENT","OUTLINE_PIXEL_PERFECT","OUTLINE_URP_FEATURE","OUTLINE_CLIP_SPACE","FOG","OUTLINE_OPAQUE","SSAO","ENABLE_META_PASS","OUTLINE_LIGHTING_VERT","OUTLINE_LIGHTING","OUTLINE_LIGHTING_WRAP","OUTLINE_ZSMOOTH","TEMPLATE_LWRP","OUTLINE_MIN_WIDTH","OUTLINE_MAX_WIDTH"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[,,,,,,,,,,sp(name:"Specular Color";imps:list[imp_mp_color(def:RGBA(0.5, 0.5, 0.5, 1);hdr:False;cc:3;chan:"RGB";prop:"_SpecularColor";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"f28d6312-06df-4158-8b98-73fe0e4869d6";op:Multiply;lbl:"Specular Color";gpu_inst:False;locked:False;impl_index:0),imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_SpecularColor1";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"dffc4ea0-6b6c-4b47-9d05-8eb3e1ee97f7";op:Multiply;lbl:"Specular Color Texture";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),,,sp(name:"Emission";imps:list[imp_mp_color(def:RGBA(0, 0, 0, 1);hdr:True;cc:3;chan:"RGB";prop:"_Emission";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"2ecbe8c8-fb99-46bf-9248-5496b529fa84";op:Multiply;lbl:"Emission Color";gpu_inst:False;locked:False;impl_index:0),imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_Emission1";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"39a12f9e-0a16-4550-adf9-0aa95499d9e7";op:Multiply;lbl:"Emission Texture";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False),sp(name:"MatCap Color";imps:list[imp_mp_color(def:RGBA(1, 1, 1, 1);hdr:False;cc:3;chan:"RGB";prop:"_MatCapColor";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"cb6a522b-609b-4fd0-a3f4-2f1108daebb8";op:Multiply;lbl:"MatCap Color";gpu_inst:False;locked:False;impl_index:0),imp_mp_texture(uto:False;tov:"";tov_lbl:"";gto:False;sbt:False;scr:False;scv:"";scv_lbl:"";gsc:False;roff:False;goff:False;sin_anm:False;sin_anmv:"";sin_anmv_lbl:"";gsin:False;notile:False;triplanar_local:False;def:"white";locked_uv:False;uv:0;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:Texcoord;uv_chan:"XZ";tpln_scale:1;uv_shaderproperty:__NULL__;uv_cmp:__NULL__;sep_sampler:__NULL__;prop:"_MatCapColor1";md:"";gbv:False;custom:False;refs:"";pnlock:False;guid:"bab2374d-d340-477a-9324-458da83522fc";op:Multiply;lbl:"MatCap Color Texture";gpu_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 10dbfd579e05add426fcacc145feada9 */
