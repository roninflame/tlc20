...
Shader "Toony Colors Pro 2/User/My TCP2 Shader"
{
	Properties
	{
		...
		[NoScaleOffset] _SketchColor ("Sketch Color", 2D) = "black" {}
		[TCP2Separator]
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _RimMax;
			fixed4 _RimColor;
			sampler2D _SketchColor;
			float4 _SketchColor_TexelSize;
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				float3 __sketchColor = ( tex2D(_SketchColor, screenUV * _SketchColor_TexelSize.xy * _ScreenParams.xy * _SketchTexture_ST.xy + _SketchTexture_ST.zw).rgb );
...
/* TCP_DATA u config(unity:"2019.4.11f1";ver:"2.5.1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","RAMP_BANDS_CRISP_NO_AA","BYPASS_LIGHT_FALLOFF","RIM","SKETCH","TEMPLATE_LWRP"];flags:list[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[,,,,,,,,,,,,,,,sp(name:"Sketch Color";imps:list[imp_mp_texture(uto:True;tov:"_SketchTexture_ST";gto:False;sbt:True;scr:False;scv:"";gsc:False;roff:False;goff:False;notile:False;def:"black";locked_uv:False;uv:4;cc:3;chan:"RGB";mip:-1;mipprop:False;ssuv_vert:False;ssuv_obj:False;uv_type:ScreenSpace;uv_chan:"XZ";uv_shaderproperty:__NULL__;prop:"_SketchColor";md:"";custom:False;refs:"";guid:"ecf0fbfe-8342-4d8c-b319-b79ba5ba4036";op:Multiply;lbl:"Sketch Color";gpu_inst:False;locked:False;impl_index:-1)])];customTextures:list[]) */
/* TCP_HASH 4c116886050261ff8acd4ab440c386bb */
